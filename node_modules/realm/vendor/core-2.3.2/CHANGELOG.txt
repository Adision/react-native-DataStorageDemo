...
-   Fixed bug when encryption was used. It would cause crashes and
    corrupted data (sometimes pieces of data from earlier commits could
    be seen). PR #2465. (fixes
    https://github.com/realm/realm-core/issues/2383)
...
-   Remove the BinaryData constructor taking a temporary object to
    prevent some errors in unit tests at compile time.
